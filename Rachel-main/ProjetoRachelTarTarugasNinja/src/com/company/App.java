...
public class App {
    public static void main(String[] args) {
        ...
        Personagem[] t = new Personagem[7]; // Declaração de Array dos personagens elas herdam os atributos da classe pai

        // declarando os personagens
        t[0] = new Personagem("Leonardo", 20, "Espadas", 2);
        t[1] = new Personagem("Raphael", 20, "Sai", 2);
        t[2] = new Personagem("Donatello", 20, "Bastao", 2);
        t[3] = new Personagem("Michelangello", 20, "Nunchaku", 2);
        t[4] = new Personagem("Cabeca-de-Couro", 35, "Mordida", 0);
        t[5] = new Personagem("Karai", 20, "Espadas",0);
        t[6] = new Personagem("Destruidor", 100, "Espadas", 0);
        ...
        while (t[tartaruga].getVida() > 0) {
            System.out.println("Seu Hp foi restaurado!!");
            t[tartaruga].setVida(120);
            System.out.println("HP: " + t[tartaruga].getVida());
            ...
            if (n == 1 && t[5].getVida()>0) {
                ...
                int level;
                level = 0;
                int pizza = t[tartaruga].getPizza();
                while (level < 1) {
                    ...
                    if (t[5].getVida() < 1) {
                        ...
                        System.out.println("Depois de travar sua batalha mortal contra Karai você resolveu voltar para os esgotos para tratar seus ferimentos");
               ...
               System.out.println("Você encontrou o destruidor");
            }
            ...
            if (n == 2 &&  t[6].getVida() <=0) {
                ...
                int level2;
                level2 = 0;
                int pizza2 = t[tartaruga].getPizza();
                while (level2 < 1) {
                    ...
                    if (t[4].getVida() < 1) {
                        ...
                        System.out.println("Você venceu e achou um pedaço de papel com ele esta escrito  123 talvez seja a senha para algo...");
                        System.out.println("Você voltou para o esgoto");
            ...
            if (n == 2 && t[6].getVida() <=0) {
                System.out.println("Você Derrotou o inimigo não tem ninguém aqui");
        }
        ...
        if (n == 3) {
                try {
                    ...
                    if (s == senha) {
                        ...
                        t[tartaruga].setPizza(100);
                        System.out.println("Voce tem " + t[tartaruga].getPizza() + "pizzas" );
                    }
